...
def _build_invoice_json(invoice_doc, cost_center_doc=None):
    ...
    return {
        ...
        "DeviceID": invoice_doc.get("custom_device_id") or "",
        "DeviceSerial": invoice_doc.get("custom_device_serial_no") or "",
        "FiscalDay": invoice_doc.get("custom_fiscal_day") or "",
...
def generate_quotation_json(quote_id):
    ...
    data = {
        ...
        "CompanyAddress": company.get("custom_company_email") or "",
        "City": company.city or "",
        "State": company.state or "",
        "postcode": company.custom_post_code or "",
        "contact": company.custom_contact_number or "",
        "CompanyEmail": company.get("custom_company_email") or "",
