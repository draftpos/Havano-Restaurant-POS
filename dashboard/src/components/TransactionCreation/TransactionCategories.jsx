...
const TransactionCategories = () => {
  const { menuCategories, fetchMenuCategories } = useTransactionCreationStore();
  const [categoryColors, setCategoryColors] = useState({});
  const [categoryCounts, setCategoryCounts] = useState({});
  const selectedCategory = useTransactionCreationStore((state) => state.selectedCategory);
  const setSelectedCategory = useTransactionCreationStore((state) => state.setSelectedCategory);
